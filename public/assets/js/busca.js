...
console.log('🔍 [BuscaGlobal] Módulo carregado completamente');
    ...
    // EXPORTAR FUNÇÕES IMEDIATAMENTE APÓS DEFINIÇÃO
    window.abrirBuscaReserva = abrirBuscaReserva;
    console.log('🔍 [BuscaGlobal] abrirBuscaReserva exportada:', typeof window.abrirBuscaReserva);
    ...
    // EXPORTAR buscarReserva IMEDIATAMENTE APÓS DEFINIÇÃO
    window.buscarReserva = buscarReserva;
    console.log('🔍 [BuscaGlobal] buscarReserva exportada:', typeof window.buscarReserva);
    ...
    // EXPORTAR mostrarResultadoBusca IMEDIATAMENTE APÓS DEFINIÇÃO
    window.mostrarResultadoBusca = mostrarResultadoBusca;
    console.log('🔍 [BuscaGlobal] mostrarResultadoBusca exportada:', typeof window.mostrarResultadoBusca);
    ...
    console.log('🔍 [BuscaGlobal] Módulo carregado completamente');
    console.log('🔍 [BuscaGlobal] Funções disponíveis:', {
        abrirBuscaReserva: typeof window.abrirBuscaReserva,
        buscarReserva: typeof window.buscarReserva,
        mostrarResultadoBusca: typeof window.mostrarResultadoBusca
    });
